...
`;
  ...
  function createPanel(forms) {
    ...
    title.innerHTML = 'AppyCrew Scan <span>OCR + image recognition to auto-fill this form</span>';
  ...
  function buildMappings(forms, text, vision) {
    ...
    function candidateValue(meta, elType) {
      ...
      if (str.indexOf("description") !== -1 || str.indexOf("notes") !== -1) {
        if (visionDesc) {
          return visionDesc;
        }
